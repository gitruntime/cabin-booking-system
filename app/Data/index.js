export const departments = ['IT', 'HR', 'Finance', 'Marketing', 'Sales', 'Operations', 'Customer Support', 'Legal', 'Research & Development', 'Administration'];

export const cabinFacilities = ['Projector', 'TV', 'Whiteboard', 'Video Conference', 'Audio System', 'Air Conditioning', 'Heating', 'Wi-Fi', 'Coffee Machine', 'Refrigerator'];
